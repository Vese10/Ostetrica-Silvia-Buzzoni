...
<head>
  ...
  <meta property="og:title" content="Storie di Nascita a Ferrara e dintorni - Ostetrica Silvia Buzzoni - Nascita Diletta">
  ...
  <link rel="canonical" href="https://ostetricasilviabuzzoni.it/blog/storie-di-nascita/nascita-diletta">
  ...
  <title>Storie di Nascita a Ferrara e dintorni - Ostetrica Silvia Buzzoni - Nascita Diletta</title>
...
<body>
  ...
  <article class="container-fluid d-flex flex-column justify-content-center align-items-center p-0 stories-section text-center">
    <div class="row d-flex justify-content-center m-lg-5 m-2">
      <!-- Immagine grande -->
      <div class="row d-flex justify-content-center align-items-center col-md-5">
        <div class="row">
          <div class="col-12">
            <img src="../../assets/img/immagine-prova.jpg" alt="Immagine nascita 1" class="img-fluid mb-4 img-stories" loading="lazy">
          </div>
        </div>
      </div>
      <!-- Testo con titolo e sottotitolo -->
      <div class="col-md-7 d-flex flex-column justify-content-around">
        <h1 class="title">Rinasce una donna ed un’intera famiglia🧡</h1>
        <h2 class="sub-title">17 Febbraio 2025</h2>
        <div>
          <p class="text w-100">Dolcissima Diletta,<br>
            La tua mamma ed il tuo papà
            speravano in un parto caldo, intimo, gioioso.
            Sognavano un evento
            che lasciasse loro un’impronta diversa
            da quella vissuta in precedenza.</p>
          <p class="text w-100">La tua mamma si é preparata,
            si é ascoltata,
            ha accolto tutte le paure.</p>
          <p class="text w-100">Poi la telefonata al mattino presto,
            il mio arrivo di corsa.
            La doccia calda in cui risuonavano lunghe vocali.
            La visita.
            Diletta, non sei di certo una bimba che perde tempo.
            “Bea, vestiti. Andiamo!”
            Fabri, il tuo fratellone, era steso sul divano a riposare.
            Un bacio al volo e usciamo di casa.
            Il nostro arrivo in sala parto insieme.
            Gli sguardi pieni di emozione mescolati alla fatica.
            Poche spinte.</p>
          <p class="text w-100">Dopo poco la tua mamma
            ti ha accolta tra le braccia
            con un sorriso incredulo.
            Eccoti!

            Poi solo il vostro pelle a pelle, lunghissimo.
            Occhi negli occhi.
            Tempo che cura e lenisce come un balsamo.</p>
          <p class="text w-100">La tua nascita é arrivata
            per rendere le feste di Natale
            ancora più speciali.
            Non a caso in testa avevi un grande fiocco, quel giorno.</p>
          <p class="text w-100">Grazie per avermi desiderata al vostro fianco.</p>
          <a href="https://ostetricasilviabuzzoni.it/storie-di-nascita" class="btn btn-accordion">Torna agli articoli</a>
        </div>
      </div>
    </div>
  </article>
