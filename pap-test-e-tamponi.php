...
<head>
  ...
  <meta property="og:title" content="Pap Test e Tamponi - Ostetrica Silvia Buzzoni">
  <meta property="og:description" content="D.ssa Silvia Buzzoni Ostetrica Libera Professionista a Ferrara e provincia - Pap Test e Tamponi">
  <meta property="og:image" content="https://ostetricasilviabuzzoni.it/assets/img/favicon.webp">
  <meta property="og:url" content="https://ostetricasilviabuzzoni.it/pap-test-e-tamponi">
  <meta property="og:type" content="website">
  <meta property="og:locale" content="it_IT">
  <meta name="description" content="Dottoressa Silvia Buzzoni Ostetrica Libera Professionista a Ferrara e provincia - Pap Test e Tamponi">
  ...
  <title>Pap Test e Tamponi - Ostetrica Silvia Buzzoni</title>
...
<body>
  ...
  <section class="container-fluid d-flex flex-column justify-content-between align-items-center p-0 gravidanza-section text-center" id="gravidanza-section">
    <h1 class="title px-4 mt-5">Pap test e tamponi</h1>
    <div class="container-fluid d-flex flex-column p-0">
      <div class="domicilio-cont ">
        <img src="assets/img/tampone-e-pap-test-ferrara.webp" alt="Provette e tamponti per pap test a Ferrara" loading="lazy" class="img-fluid visita-grav-img">
      </div>
      <div class="row justify-content-center p-0">
        <div class="d-flex flex-column align-items-center justify-content-center p-2 p-lg-5 visit-cont">
          <p class="text">L’ostetrica è la figura competente per l’esecuzione di prestazioni ambulatoriali quali:</p>
          <ul class="text list-acc">
            <li>Pap test;</li>
            <li>Tamponi vaginali;</li>
            <li>Tamponi cervico-vaginali;</li>
          </ul>
          <p class="text">Tali prestazioni si eseguono senza necessità di prescrizione medica, previo appuntamento.</p>

          <a href="https://ostetricasilviabuzzoni.simplybook.it/v2/#book/service/13/count/1/" class="btn btn-accordion">Prenota visita</a>
        </div>
      </div>
    </div>
  </section>
